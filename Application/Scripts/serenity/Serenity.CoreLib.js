...
(function (Q) {
    ...
    function confirm(message, onYes, options) {
        ...
        options = $.extend({
            htmlEncode: true,
            yesButton: Q.text('Yes'),
            noButton: Q.text('No'),
            title: Q.text('Confirm'),
            onNo: null,
            onCancel: null,
            onClose: null,
            autoOpen: false,
...
(function ($) {
    $.widget("ui.slickPager", {
        options: {
            ...
            //2018/02/02 add more row per page
            rowsPerPageOptions: [20, 30, 50, 100, 500, 2500],
            //Enterprise Solution
            onRpChange: null
        },
        _create: function () {
            ...
            this.element.addClass('s-SlickPager slick-pg')
                ...
                '<span class="slick-pg-control">&nbsp;' + "Page" +
        ...
        _updatePager: function () {
            ...
            if (info.loading) {
                ...
                stat = "Showing {from} to {to} of {total} total records";
...
(function (App) {
    var ProcessUnitType;
    (function (ProcessUnitType) {
        ProcessUnitType[ProcessUnitType["Undefine"] = 0] = "Undefine";
        ProcessUnitType[ProcessUnitType["Curede"] = 1] = "Curede";
        ProcessUnitType[ProcessUnitType["Secondary"] = 2] = "Secondary";
    })(ProcessUnitType = App.ProcessUnitType || (App.ProcessUnitType = {}));
    var IsShutdownOption;
    (function (IsShutdownOption) {
        IsShutdownOption[IsShutdownOption["Undefine"] = 0] = "Undefine";
        IsShutdownOption[IsShutdownOption["Normal"] = 1] = "Normal";
        IsShutdownOption[IsShutdownOption["Shutdown"] = 2] = "Shutdown";
    })(IsShutdownOption = App.IsShutdownOption || (App.IsShutdownOption = {}));
    var OrderType;
    (function (OrderType) {
        OrderType[OrderType["Loading"] = 1] = "Loading";
        OrderType[OrderType["Discharge"] = 2] = "Discharge";
    })(OrderType = App.OrderType || (App.OrderType = {}));
    var ShipmentOperationType;
    (function (ShipmentOperationType) {
        ShipmentOperationType[ShipmentOperationType["Anchorage"] = 1] = "Anchorage";
        ShipmentOperationType[ShipmentOperationType["WharfNomination"] = 2] = "WharfNomination";
        ShipmentOperationType[ShipmentOperationType["Berthing"] = 3] = "Berthing";
        ShipmentOperationType[ShipmentOperationType["Sailing"] = 4] = "Sailing";
        ShipmentOperationType[ShipmentOperationType["WharfChangeSailing"] = 5] = "WharfChangeSailing";
        ShipmentOperationType[ShipmentOperationType["WharfChangeBerthing"] = 6] = "WharfChangeBerthing";
    })(ShipmentOperationType = App.ShipmentOperationType || (App.ShipmentOperationType = {}));
    var TaskType;
    (function (TaskType) {
        TaskType[TaskType["Feed"] = 1] = "Feed";
        TaskType[TaskType["Rundown"] = 2] = "Rundown";
        TaskType[TaskType["Loading"] = 3] = "Loading";
        TaskType[TaskType["Discharge"] = 4] = "Discharge";
        TaskType[TaskType["Transfer"] = 5] = "Transfer";
        TaskType[TaskType["Draining"] = 6] = "Draining";
        TaskType[TaskType["Mixing"] = 7] = "Mixing";
        TaskType[TaskType["Settling"] = 8] = "Settling";
        TaskType[TaskType["Refinery"] = 9] = "Refinery";
    })(TaskType = App.TaskType || (App.TaskType = {}));
    var FeedSubType;
    (function (FeedSubType) {
        FeedSubType[FeedSubType["CrudeUnitFeed"] = 1] = "CrudeUnitFeed";
        FeedSubType[FeedSubType["SecondaryUnitFeed"] = 2] = "SecondaryUnitFeed";
        FeedSubType[FeedSubType["HotFeed"] = 3] = "HotFeed";
    })(FeedSubType = App.FeedSubType || (App.FeedSubType = {}));
    var RundownSubType;
    (function (RundownSubType) {
        RundownSubType[RundownSubType["CrudeUnitRundown"] = 101] = "CrudeUnitRundown";
        RundownSubType[RundownSubType["CrudeUnitHotRundown"] = 102] = "CrudeUnitHotRundown";
        RundownSubType[RundownSubType["SecondaryUnitRundown"] = 103] = "SecondaryUnitRundown";
        RundownSubType[RundownSubType["SecondaryUnitHotRundown"] = 104] = "SecondaryUnitHotRundown";
        RundownSubType[RundownSubType["OffGradeRundown"] = 105] = "OffGradeRundown";
        RundownSubType[RundownSubType["RecirculationRundown"] = 106] = "RecirculationRundown";
        RundownSubType[RundownSubType["RecirculationMasterRundown"] = 107] = "RecirculationMasterRundown";
    })(RundownSubType = App.RundownSubType || (App.RundownSubType = {}));
    var LoadingSubType;
    (function (LoadingSubType) {
        LoadingSubType[LoadingSubType["Loading"] = 201] = "Loading";
        LoadingSubType[LoadingSubType["BunkerLoading"] = 202] = "BunkerLoading";
    })(LoadingSubType = App.LoadingSubType || (App.LoadingSubType = {}));
    var DischargeSubType;
    (function (DischargeSubType) {
        DischargeSubType[DischargeSubType["Discharge"] = 301] = "Discharge";
    })(DischargeSubType = App.DischargeSubType || (App.DischargeSubType = {}));
    var FeedSpikeType;
    (function (FeedSpikeType) {
        FeedSpikeType[FeedSpikeType["CrudeSpike"] = 2] = "CrudeSpike";
        FeedSpikeType[FeedSpikeType["IndCrudeSpike"] = 3] = "IndCrudeSpike";
        FeedSpikeType[FeedSpikeType["SlopSpike"] = 4] = "SlopSpike";
        FeedSpikeType[FeedSpikeType["RecirculationSpike"] = 5] = "RecirculationSpike";
        FeedSpikeType[FeedSpikeType["RoundownSpike"] = 6] = "RoundownSpike";
    })(FeedSpikeType = App.FeedSpikeType || (App.FeedSpikeType = {}));
    var FeedTankType;
    (function (FeedTankType) {
        FeedTankType[FeedTankType["Undefine"] = 0] = "Undefine";
        FeedTankType[FeedTankType["MainTank"] = 1] = "MainTank";
        FeedTankType[FeedTankType["CrudeSpike"] = 2] = "CrudeSpike";
        FeedTankType[FeedTankType["IndCrudeSpike"] = 3] = "IndCrudeSpike";
        FeedTankType[FeedTankType["SlopSpike"] = 4] = "SlopSpike";
        FeedTankType[FeedTankType["RecirculationSpike"] = 5] = "RecirculationSpike";
        FeedTankType[FeedTankType["RoundownSpike"] = 6] = "RoundownSpike";
    })(FeedTankType = App.FeedTankType || (App.FeedTankType = {}));
    var StopConditionType;
    (function (StopConditionType) {
        StopConditionType[StopConditionType["Undefine"] = 0] = "Undefine";
        StopConditionType[StopConditionType["AbsoluteTime"] = 1] = "AbsoluteTime";
        StopConditionType[StopConditionType["TillLow"] = 2] = "TillLow";
        StopConditionType[StopConditionType["TillHigh"] = 3] = "TillHigh";
        StopConditionType[StopConditionType["SourceLevelTo"] = 4] = "SourceLevelTo";
        StopConditionType[StopConditionType["DestinationLevelTo"] = 5] = "DestinationLevelTo";
        StopConditionType[StopConditionType["SourceVolumeTo"] = 6] = "SourceVolumeTo";
        StopConditionType[StopConditionType["DestinationVolumeTo"] = 7] = "DestinationVolumeTo";
        StopConditionType[StopConditionType["XferQuantity"] = 8] = "XferQuantity";
        StopConditionType[StopConditionType["ElapsedHours"] = 9] = "ElapsedHours";
        StopConditionType[StopConditionType["RelatedRDTankLevel"] = 10] = "RelatedRDTankLevel";
        StopConditionType[StopConditionType["BalanceQuantity"] = 11] = "BalanceQuantity";
    })(StopConditionType = App.StopConditionType || (App.StopConditionType = {}));
    var ConditionType;
    (function (ConditionType) {
        ConditionType[ConditionType["Undefine"] = 0] = "Undefine";
        ConditionType[ConditionType["AbsoluteTime"] = 1] = "AbsoluteTime";
        ConditionType[ConditionType["TillLow"] = 2] = "TillLow";
        ConditionType[ConditionType["TillHigh"] = 3] = "TillHigh";
        ConditionType[ConditionType["TillLevel"] = 4] = "TillLevel";
        ConditionType[ConditionType["TillVolume"] = 5] = "TillVolume";
        ConditionType[ConditionType["QtyMass"] = 6] = "QtyMass";
        ConditionType[ConditionType["QtyVolume"] = 7] = "QtyVolume";
        ConditionType[ConditionType["BalanceQuantity"] = 8] = "BalanceQuantity";
    })(ConditionType = App.ConditionType || (App.ConditionType = {}));
    var TaskStatusOption;
    (function (TaskStatusOption) {
        TaskStatusOption[TaskStatusOption["None"] = 0] = "None";
        TaskStatusOption[TaskStatusOption["UnDefined"] = 1] = "UnDefined";
        TaskStatusOption[TaskStatusOption["Defined"] = 2] = "Defined";
        TaskStatusOption[TaskStatusOption["Pending"] = 3] = "Pending";
        TaskStatusOption[TaskStatusOption["Active"] = 4] = "Active";
        TaskStatusOption[TaskStatusOption["Interrupted"] = 5] = "Interrupted";
        TaskStatusOption[TaskStatusOption["Finished"] = 6] = "Finished";
        TaskStatusOption[TaskStatusOption["Completed"] = 7] = "Completed";
        TaskStatusOption[TaskStatusOption["Closed"] = 8] = "Closed";
    })(TaskStatusOption = App.TaskStatusOption || (App.TaskStatusOption = {}));
    var CCStatusOption;
    (function (CCStatusOption) {
        CCStatusOption[CCStatusOption["Undefined"] = 0] = "Undefined";
        CCStatusOption[CCStatusOption["OnSpec"] = 1] = "OnSpec";
        CCStatusOption[CCStatusOption["OffSpec"] = 2] = "OffSpec";
        CCStatusOption[CCStatusOption["Pending"] = 3] = "Pending";
        CCStatusOption[CCStatusOption["NotFound"] = 4] = "NotFound";
    })(CCStatusOption = App.CCStatusOption || (App.CCStatusOption = {}));
    var ActivityStatusOption;
    (function (ActivityStatusOption) {
        ActivityStatusOption[ActivityStatusOption["Defined"] = 1] = "Defined";
        ActivityStatusOption[ActivityStatusOption["Selected"] = 2] = "Selected";
        ActivityStatusOption[ActivityStatusOption["Nominated"] = 3] = "Nominated";
        ActivityStatusOption[ActivityStatusOption["Pending"] = 4] = "Pending";
        ActivityStatusOption[ActivityStatusOption["Active"] = 5] = "Active";
        ActivityStatusOption[ActivityStatusOption["Intereupted"] = 6] = "Intereupted";
        ActivityStatusOption[ActivityStatusOption["Finished"] = 7] = "Finished";
        ActivityStatusOption[ActivityStatusOption["Cancelled"] = 8] = "Cancelled";
    })(ActivityStatusOption = App.ActivityStatusOption || (App.ActivityStatusOption = {}));
    var RefineryTransferSourceDestinationType;
    (function (RefineryTransferSourceDestinationType) {
        RefineryTransferSourceDestinationType[RefineryTransferSourceDestinationType["Tank"] = 1] = "Tank";
        RefineryTransferSourceDestinationType[RefineryTransferSourceDestinationType["Sink"] = 2] = "Sink";
    })(RefineryTransferSourceDestinationType = App.RefineryTransferSourceDestinationType || (App.RefineryTransferSourceDestinationType = {}));
    var ActivityType;
    (function (ActivityType) {
        /// <summary>
        /// Falg : CF
        /// </summary>
        ActivityType[ActivityType["CrudeUnitFeed"] = 1] = "CrudeUnitFeed";
        /// <summary>
        /// Falg : SF
        /// </summary>
        ActivityType[ActivityType["SecondaryUnitFeed"] = 2] = "SecondaryUnitFeed";
        /// <summary>
        /// Falg : RD
        /// </summary>
        ActivityType[ActivityType["Rundown"] = 3] = "Rundown";
        /// <summary>
        /// Falg : OF
        /// </summary>
        ActivityType[ActivityType["OffGradeRundown"] = 4] = "OffGradeRundown";
        /// <summary>
        /// Falg : RC
        /// </summary>
        ActivityType[ActivityType["RecirculationRundown"] = 5] = "RecirculationRundown";
        /// <summary>
        /// Falg : LB
        /// </summary>
        ActivityType[ActivityType["ILBLoading"] = 6] = "ILBLoading";
        /// <summary>
        /// Falg : LS
        /// </summary>
        ActivityType[ActivityType["STLoading"] = 7] = "STLoading";
        /// <summary>
        /// Falg : GB
        /// </summary>
        ActivityType[ActivityType["ILBLPGLoading"] = 8] = "ILBLPGLoading";
        /// <summary>
        /// Falg : GS
        /// </summary>
        ActivityType[ActivityType["STLPGLoading"] = 9] = "STLPGLoading";
        /// <summary>
        /// Falg : BL
        /// </summary>
        ActivityType[ActivityType["BunkerLoading"] = 10] = "BunkerLoading";
        /// <summary>
        /// Falg : BX
        /// </summary>
        ActivityType[ActivityType["BunkerTransfer"] = 11] = "BunkerTransfer";
        /// <summary>
        /// Falg : DI
        /// </summary>
        ActivityType[ActivityType["Discharge"] = 12] = "Discharge";
        /// <summary>
        /// Falg : XB
        /// </summary>
        ActivityType[ActivityType["ILBTransfer"] = 13] = "ILBTransfer";
        /// <summary>
        /// Falg : XT
        /// </summary>
        ActivityType[ActivityType["STTransfer"] = 14] = "STTransfer";
        /// <summary>
        /// Falg : CB
        /// </summary>
        ActivityType[ActivityType["ILBLineClearing"] = 15] = "ILBLineClearing";
        /// <summary>
        /// Falg : CS
        /// </summary>
        ActivityType[ActivityType["STLineClearing"] = 16] = "STLineClearing";
        /// <summary>
        /// Falg : XG
        /// </summary>
        ActivityType[ActivityType["GravityTransfer"] = 17] = "GravityTransfer";
        /// <summary>
        /// Falg : XM
        /// </summary>
        ActivityType[ActivityType["CirculationMixing"] = 18] = "CirculationMixing";
        /// <summary>
        /// Falg : XX
        /// </summary>
        ActivityType[ActivityType["RefineryTransfer"] = 19] = "RefineryTransfer";
        /// <summary>
        /// Falg : XS
        /// </summary>
        ActivityType[ActivityType["SlopsTransfer"] = 20] = "SlopsTransfer";
        /// <summary>
        /// Falg : CD
        /// </summary>
        ActivityType[ActivityType["CrudeDraining"] = 21] = "CrudeDraining";
        /// <summary>
        /// Falg : SD
        /// </summary>
        ActivityType[ActivityType["SlopsDraining"] = 22] = "SlopsDraining";
        /// <summary>
        /// Falg : PS
        /// </summary>
        ActivityType[ActivityType["ProductDraining"] = 23] = "ProductDraining";
        /// <summary>
        /// Falg : MM
        /// </summary>
        ActivityType[ActivityType["Mixing"] = 24] = "Mixing";
        /// <summary>
        /// Falg : SS
        /// </summary>
        ActivityType[ActivityType["Settling"] = 25] = "Settling";
        /// <summary>
        /// Falg : AI
        /// </summary>
        ActivityType[ActivityType["AdditiveInjection"] = 26] = "AdditiveInjection";
    })(ActivityType = App.ActivityType || (App.ActivityType = {}));
    var AmendedOption;
    (function (AmendedOption) {
        AmendedOption[AmendedOption["No"] = 0] = "No";
        AmendedOption[AmendedOption["Yes"] = 1] = "Yes";
    })(AmendedOption = App.AmendedOption || (App.AmendedOption = {}));
    var YesNoOption;
    (function (YesNoOption) {
        YesNoOption[YesNoOption["No"] = 0] = "No";
        YesNoOption[YesNoOption["Yes"] = 1] = "Yes";
    })(YesNoOption = App.YesNoOption || (App.YesNoOption = {}));
    var UOMOption;
    (function (UOMOption) {
        UOMOption[UOMOption["Undefine"] = 0] = "Undefine";
        UOMOption[UOMOption["Litre"] = 1] = "Litre";
        UOMOption[UOMOption["M3"] = 2] = "M3";
        UOMOption[UOMOption["MT"] = 3] = "MT";
        /// <summary>
        /// Order.UOM
        /// </summary>
        UOMOption[UOMOption["BBLS"] = 4] = "BBLS";
        /// <summary>
        /// Level's UOM (mm)
        /// </summary>
        UOMOption[UOMOption["MM"] = 5] = "MM";
        //-------------Activity_Additive.UOM
        UOMOption[UOMOption["PPM"] = 10] = "PPM";
        UOMOption[UOMOption["MgL"] = 11] = "MgL";
        UOMOption[UOMOption["MgM3"] = 12] = "MgM3";
        UOMOption[UOMOption["MlM3"] = 13] = "MlM3";
        UOMOption[UOMOption["PercentV"] = 14] = "PercentV";
        //-------------LAB_TBRecipe.UOM
        //%VOL
        UOMOption[UOMOption["PercentVOL"] = 20] = "PercentVOL";
        //%W
        UOMOption[UOMOption["PercentW"] = 21] = "PercentW";
        //%MT
        UOMOption[UOMOption["PercentMT"] = 22] = "PercentMT";
    })(UOMOption = App.UOMOption || (App.UOMOption = {}));
    var OperationModeDestinationType;
    (function (OperationModeDestinationType) {
        OperationModeDestinationType[OperationModeDestinationType["Undefine"] = 0] = "Undefine";
        OperationModeDestinationType[OperationModeDestinationType["SD"] = 1] = "SD";
        OperationModeDestinationType[OperationModeDestinationType["Tank"] = 2] = "Tank";
        OperationModeDestinationType[OperationModeDestinationType["ProcessUnit"] = 3] = "ProcessUnit";
    })(OperationModeDestinationType = App.OperationModeDestinationType || (App.OperationModeDestinationType = {}));
    var TickFlagOption;
    (function (TickFlagOption) {
        TickFlagOption[TickFlagOption["None"] = 0] = "None";
        TickFlagOption[TickFlagOption["Activation"] = 1] = "Activation";
        TickFlagOption[TickFlagOption["Stop"] = 2] = "Stop";
        TickFlagOption[TickFlagOption["Deletion"] = 3] = "Deletion";
        TickFlagOption[TickFlagOption["SwingRequest"] = 4] = "SwingRequest";
    })(TickFlagOption = App.TickFlagOption || (App.TickFlagOption = {}));
    var OpFlagOption;
    (function (OpFlagOption) {
        OpFlagOption[OpFlagOption["None"] = 0] = "None";
        OpFlagOption[OpFlagOption["RequestActivation"] = 1] = "RequestActivation";
        OpFlagOption[OpFlagOption["Activation"] = 2] = "Activation";
        OpFlagOption[OpFlagOption["RequestStop"] = 3] = "RequestStop";
        OpFlagOption[OpFlagOption["Stop"] = 4] = "Stop";
        OpFlagOption[OpFlagOption["RequestSwitchOver"] = 5] = "RequestSwitchOver";
        OpFlagOption[OpFlagOption["RequestDeletion"] = 6] = "RequestDeletion";
        OpFlagOption[OpFlagOption["Deletion"] = 7] = "Deletion";
    })(OpFlagOption = App.OpFlagOption || (App.OpFlagOption = {}));
    var EquipmentType;
    (function (EquipmentType) {
        EquipmentType[EquipmentType["None"] = 0] = "None";
        EquipmentType[EquipmentType["Line"] = 1] = "Line";
        EquipmentType[EquipmentType["Pump"] = 2] = "Pump";
        EquipmentType[EquipmentType["Sink"] = 3] = "Sink";
        EquipmentType[EquipmentType["Spade"] = 4] = "Spade";
        EquipmentType[EquipmentType["Tank"] = 5] = "Tank";
        EquipmentType[EquipmentType["Unit"] = 6] = "Unit";
        EquipmentType[EquipmentType["Valve"] = 7] = "Valve";
        EquipmentType[EquipmentType["Wharf"] = 8] = "Wharf";
        EquipmentType[EquipmentType["BlendController"] = 9] = "BlendController";
        EquipmentType[EquipmentType["AutoSampler"] = 10] = "AutoSampler";
        EquipmentType[EquipmentType["DigitalSwitch"] = 11] = "DigitalSwitch";
        EquipmentType[EquipmentType["CustodyMeter"] = 12] = "CustodyMeter";
        EquipmentType[EquipmentType["FlowController"] = 13] = "FlowController";
        EquipmentType[EquipmentType["HandController"] = 14] = "HandController";
        EquipmentType[EquipmentType["AdditiveVessel"] = 15] = "AdditiveVessel";
        EquipmentType[EquipmentType["Boom"] = 16] = "Boom";
        EquipmentType[EquipmentType["Microfilter"] = 17] = "Microfilter";
        EquipmentType[EquipmentType["BunkerMeter"] = 18] = "BunkerMeter";
        EquipmentType[EquipmentType["Mixer"] = 21] = "Mixer";
        EquipmentType[EquipmentType["Other"] = 99] = "Other";
    })(EquipmentType = App.EquipmentType || (App.EquipmentType = {}));
    var PathType;
    (function (PathType) {
        PathType[PathType["DischargeHeader"] = 1] = "DischargeHeader";
        PathType[PathType["Discharge"] = 2] = "Discharge";
        PathType[PathType["SuctionPath"] = 3] = "SuctionPath";
        PathType[PathType["Pump"] = 4] = "Pump";
        PathType[PathType["Boom"] = 5] = "Boom";
        PathType[PathType["AdditiveInjection"] = 6] = "AdditiveInjection";
        PathType[PathType["LPGSpikingSuction"] = 7] = "LPGSpikingSuction";
        PathType[PathType["Microfilter"] = 8] = "Microfilter";
        PathType[PathType["MiniFlowReturn"] = 9] = "MiniFlowReturn";
        PathType[PathType["VaporReturn"] = 10] = "VaporReturn";
        PathType[PathType["LineClearing"] = 11] = "LineClearing";
        PathType[PathType["Precanned"] = 12] = "Precanned";
        PathType[PathType["LPGSpikingDischargeHeader"] = 13] = "LPGSpikingDischargeHeader";
        PathType[PathType["LPGSpikingDischarge"] = 14] = "LPGSpikingDischarge";
        PathType[PathType["LPGSpikingPump"] = 15] = "LPGSpikingPump";
        PathType[PathType["LPGSpikingReturn"] = 16] = "LPGSpikingReturn";
        PathType[PathType["CrudeSpikingSuctionOne"] = 17] = "CrudeSpikingSuctionOne";
        PathType[PathType["CrudeSpikingDischargeHeaderOne"] = 18] = "CrudeSpikingDischargeHeaderOne";
        PathType[PathType["CrudeSpikingDischargeOne"] = 19] = "CrudeSpikingDischargeOne";
        PathType[PathType["CrudeSpikingPumpOne"] = 20] = "CrudeSpikingPumpOne";
        PathType[PathType["CrudeSpikingSuctionTwo"] = 21] = "CrudeSpikingSuctionTwo";
        PathType[PathType["CrudeSpikingDischargeHeaderTwo"] = 22] = "CrudeSpikingDischargeHeaderTwo";
        PathType[PathType["CrudeSpikingDischargeTwo"] = 23] = "CrudeSpikingDischargeTwo";
        PathType[PathType["CrudeSpikingPumpTwo"] = 24] = "CrudeSpikingPumpTwo";
        PathType[PathType["IndCrudeSpikingSuction"] = 25] = "IndCrudeSpikingSuction";
        PathType[PathType["IndCrudeSpikingDischargeHeader"] = 26] = "IndCrudeSpikingDischargeHeader";
        PathType[PathType["IndCrudeSpikingDischarge"] = 27] = "IndCrudeSpikingDischarge";
        PathType[PathType["IndCrudeSpikingPump"] = 28] = "IndCrudeSpikingPump";
        PathType[PathType["SlopSpikingSuction"] = 29] = "SlopSpikingSuction";
        PathType[PathType["SlopSpikingDischargeHeader"] = 30] = "SlopSpikingDischargeHeader";
        PathType[PathType["SlopSpikingDischarge"] = 31] = "SlopSpikingDischarge";
        PathType[PathType["SlopSpikingPump"] = 32] = "SlopSpikingPump";
        PathType[PathType["RecirculationSpikingSuction"] = 33] = "RecirculationSpikingSuction";
        PathType[PathType["RecirculationSpikingDischargeHeader"] = 34] = "RecirculationSpikingDischargeHeader";
        PathType[PathType["RecirculationSpikingDischarge"] = 35] = "RecirculationSpikingDischarge";
        PathType[PathType["RecirculationSpikingPump"] = 36] = "RecirculationSpikingPump";
        PathType[PathType["RundownSpikingSuction"] = 103] = "RundownSpikingSuction";
        PathType[PathType["RundownSpikingDischargeHeader"] = 104] = "RundownSpikingDischargeHeader";
        PathType[PathType["RundownSpikingDischarge"] = 105] = "RundownSpikingDischarge";
        PathType[PathType["RundownSpikingPump"] = 106] = "RundownSpikingPump";
    })(PathType = App.PathType || (App.PathType = {}));
    var PathSelectRuleType;
    (function (PathSelectRuleType) {
        PathSelectRuleType[PathSelectRuleType["None"] = 0] = "None";
        PathSelectRuleType[PathSelectRuleType["Restriction"] = 1] = "Restriction";
        PathSelectRuleType[PathSelectRuleType["PrioritizationSequence"] = 2] = "PrioritizationSequence";
        PathSelectRuleType[PathSelectRuleType["LineSegment"] = 3] = "LineSegment";
    })(PathSelectRuleType = App.PathSelectRuleType || (App.PathSelectRuleType = {}));
    var PathSelectRuleNOOption;
    (function (PathSelectRuleNOOption) {
        PathSelectRuleNOOption[PathSelectRuleNOOption["None"] = 0] = "None";
        PathSelectRuleNOOption[PathSelectRuleNOOption["ExcludeLine"] = 1] = "ExcludeLine";
        PathSelectRuleNOOption[PathSelectRuleNOOption["LineService"] = 2] = "LineService";
        PathSelectRuleNOOption[PathSelectRuleNOOption["ExcludeLineType"] = 3] = "ExcludeLineType";
        PathSelectRuleNOOption[PathSelectRuleNOOption["IncludeLineType"] = 4] = "IncludeLineType";
        PathSelectRuleNOOption[PathSelectRuleNOOption["IncludeLine"] = 5] = "IncludeLine";
        PathSelectRuleNOOption[PathSelectRuleNOOption["MinLineClearingVolume"] = 101] = "MinLineClearingVolume";
        PathSelectRuleNOOption[PathSelectRuleNOOption["MinCountOfLineSegments"] = 102] = "MinCountOfLineSegments";
        PathSelectRuleNOOption[PathSelectRuleNOOption["CustodayMeterAvailable"] = 103] = "CustodayMeterAvailable";
        PathSelectRuleNOOption[PathSelectRuleNOOption["AutoSamplerAvailable"] = 104] = "AutoSamplerAvailable";
        PathSelectRuleNOOption[PathSelectRuleNOOption["MinCountOfPumps"] = 201] = "MinCountOfPumps";
        PathSelectRuleNOOption[PathSelectRuleNOOption["MinPowerConsumption"] = 202] = "MinPowerConsumption";
        PathSelectRuleNOOption[PathSelectRuleNOOption["MaxFlowrateRange"] = 203] = "MaxFlowrateRange";
        PathSelectRuleNOOption[PathSelectRuleNOOption["MinTotalRunningHours"] = 204] = "MinTotalRunningHours";
    })(PathSelectRuleNOOption = App.PathSelectRuleNOOption || (App.PathSelectRuleNOOption = {}));
    var PathSelectionModeOption;
    (function (PathSelectionModeOption) {
        PathSelectionModeOption[PathSelectionModeOption["Available"] = 1] = "Available";
        PathSelectionModeOption[PathSelectionModeOption["Possible"] = 2] = "Possible";
        PathSelectionModeOption[PathSelectionModeOption["Feasible"] = 3] = "Feasible";
    })(PathSelectionModeOption = App.PathSelectionModeOption || (App.PathSelectionModeOption = {}));
    var PreferredPathOption;
    (function (PreferredPathOption) {
        PreferredPathOption[PreferredPathOption["None"] = 0] = "None";
        PreferredPathOption[PreferredPathOption["LastUsed"] = 1] = "LastUsed";
        PreferredPathOption[PreferredPathOption["MostUsed"] = 2] = "MostUsed";
    })(PreferredPathOption = App.PreferredPathOption || (App.PreferredPathOption = {}));
    var PathSelectionStepNo;
    (function (PathSelectionStepNo) {
        PathSelectionStepNo[PathSelectionStepNo["DischargeHeader"] = 1] = "DischargeHeader";
        PathSelectionStepNo[PathSelectionStepNo["Discharge"] = 2] = "Discharge";
        PathSelectionStepNo[PathSelectionStepNo["SuctionPath"] = 3] = "SuctionPath";
        PathSelectionStepNo[PathSelectionStepNo["Pump"] = 4] = "Pump";
        PathSelectionStepNo[PathSelectionStepNo["Boom"] = 5] = "Boom";
        PathSelectionStepNo[PathSelectionStepNo["AdditiveInjection"] = 6] = "AdditiveInjection";
        PathSelectionStepNo[PathSelectionStepNo["LPGSpiking"] = 7] = "LPGSpiking";
        PathSelectionStepNo[PathSelectionStepNo["Microfilter"] = 8] = "Microfilter";
        PathSelectionStepNo[PathSelectionStepNo["MiniFlowReturn"] = 9] = "MiniFlowReturn";
        PathSelectionStepNo[PathSelectionStepNo["VaporReturn"] = 10] = "VaporReturn";
        PathSelectionStepNo[PathSelectionStepNo["LineClearing"] = 11] = "LineClearing";
        PathSelectionStepNo[PathSelectionStepNo["DeterminaRestrictionAndPriority"] = 101] = "DeterminaRestrictionAndPriority";
        PathSelectionStepNo[PathSelectionStepNo["FullPath"] = 102] = "FullPath";
        PathSelectionStepNo[PathSelectionStepNo["CrudeSpikingOne"] = 17] = "CrudeSpikingOne";
        PathSelectionStepNo[PathSelectionStepNo["CrudeSpikingTwo"] = 21] = "CrudeSpikingTwo";
        PathSelectionStepNo[PathSelectionStepNo["IndCrudeSpiking"] = 25] = "IndCrudeSpiking";
        PathSelectionStepNo[PathSelectionStepNo["SlopSpiking"] = 29] = "SlopSpiking";
        PathSelectionStepNo[PathSelectionStepNo["RecirculationSpiking"] = 33] = "RecirculationSpiking";
        PathSelectionStepNo[PathSelectionStepNo["RundownSpiking"] = 103] = "RundownSpiking";
        PathSelectionStepNo[PathSelectionStepNo["Precanned"] = 12] = "Precanned";
    })(PathSelectionStepNo = App.PathSelectionStepNo || (App.PathSelectionStepNo = {}));
    var Format = /** @class */ (function () {
        function Format() {
        }
        Format.ONUMBER = "onumber";
        Format.ODATE = "odate";
        return Format;
    }());
    App.Format = Format;
    var FormatValue = /** @class */ (function () {
        function FormatValue() {
        }
        FormatValue.ONUMBER = "#,###.000";
        return FormatValue;
    }());
    ...
    var ParamKey = /** @class */ (function () {
        function ParamKey() {
        }
        ParamKey.ID = "id";
        ParamKey.ActivityId = "activityid";
        ParamKey.TaskId = "taskid";
        ParamKey.OPERATION = "operation";
        ParamKey.PAGECHANGE = "pagechage";
        return ParamKey;
    }());
    App.ParamKey = ParamKey;
    ...
    var MasterDataType = /** @class */ (function () {
        function MasterDataType() {
        }
        MasterDataType.ProductPool = "ProductPool";
        MasterDataType.ProductGroup = "ProductGroup";
        MasterDataType.Product = "Product";
        MasterDataType.ProductProperty = "ProductProperty";
        MasterDataType.ProductPropertyData = "ProductPropertyData";
        MasterDataType.BlendProProductPropertyDataMapping = "BlendProProductPropertyDataMapping";
        MasterDataType.Crude = "Crude";
        MasterDataType.CrudeProductMapping = "CrudeProductMapping";
        MasterDataType.Additive = "Additive";
        MasterDataType.ProductAdditiveMapping = "ProductAdditiveMapping";
        MasterDataType.AdditiveVessel = "AdditiveVessel";
        MasterDataType.AutoSampler = "AutoSampler";
        MasterDataType.BlendController = "BlendController";
        MasterDataType.Boom = "Boom";
        MasterDataType.DigitalSwitch = "DigitalSwitch";
        MasterDataType.HandController = "HandController";
        MasterDataType.Line = "Line";
        MasterDataType.Meter = "Meter";
        MasterDataType.Microfilter = "Microfilter";
        MasterDataType.PumpHouse = "PumpHouse";
        MasterDataType.Pump = "Pump";
        MasterDataType.PumpMeterMapping = "PumpMeterMapping";
        MasterDataType.RatioController = "RatioController";
        MasterDataType.ProcessUnit = "ProcessUnit";
        MasterDataType.ProcessUnitProductPoolMapping = "ProcessUnitProductPoolMapping";
        MasterDataType.RundownStream = "RundownStream";
        MasterDataType.RundownStreamProductPoolMapping = "RundownStreamProductPoolMapping";
        MasterDataType.RundownCut = "RundownCut";
        MasterDataType.RundownCutProductGroupMapping = "RundownCutProductGroupMapping";
        MasterDataType.Ship = "Ship";
        MasterDataType.Sink = "Sink";
        MasterDataType.Spade = "Spade";
        MasterDataType.Tank = "Tank";
        MasterDataType.Valve = "Valve";
        MasterDataType.Wharf = "Wharf";
        MasterDataType.Mixer = "Mixer";
        MasterDataType.TankArm = "TankArm";
        MasterDataType.TankMixerActivation = "TankMixerActivation";
        MasterDataType.ProductCompatibility = "ProductCompatibility";
        MasterDataType.CustodyMeter = "CustodyMeter";
        MasterDataType.PipelineProductVT = "PipelineProductVT";
        MasterDataType.PipelineProductMapping = "PipelineProductMapping";
        MasterDataType.CustodyMeterVT = "CustodyMeterVT";
        MasterDataType.CustodyMeterVTMapping = "CustodyMeterVTMapping";
        MasterDataType.FlowController = "FlowController";
        return MasterDataType;
    }());
    App.MasterDataType = MasterDataType;
    var SwingPatternOption;
    (function (SwingPatternOption) {
        SwingPatternOption[SwingPatternOption["Original"] = 1] = "Original";
        SwingPatternOption[SwingPatternOption["SWPattern1"] = 2] = "SWPattern1";
        SwingPatternOption[SwingPatternOption["SWPattern2"] = 3] = "SWPattern2";
        SwingPatternOption[SwingPatternOption["SWPattern3"] = 4] = "SWPattern3";
    })(SwingPatternOption = App.SwingPatternOption || (App.SwingPatternOption = {}));
    var ActionSourceOption;
    (function (ActionSourceOption) {
        ActionSourceOption[ActionSourceOption["Next"] = 1] = "Next";
        ActionSourceOption[ActionSourceOption["Save"] = 2] = "Save";
        ActionSourceOption[ActionSourceOption["Terminat"] = 3] = "Terminat";
    })(ActionSourceOption = App.ActionSourceOption || (App.ActionSourceOption = {}));
    var TaskSubType;
    (function (TaskSubType) {
        TaskSubType[TaskSubType["CrudeUnitFeed"] = 1] = "CrudeUnitFeed";
        TaskSubType[TaskSubType["SecondaryUnitFeed"] = 2] = "SecondaryUnitFeed";
        TaskSubType[TaskSubType["HotFeed"] = 3] = "HotFeed";
        TaskSubType[TaskSubType["CrudeUnitRundown"] = 101] = "CrudeUnitRundown";
        TaskSubType[TaskSubType["CrudeUnitHotRundown"] = 102] = "CrudeUnitHotRundown";
        TaskSubType[TaskSubType["SecondaryUnitRundown"] = 103] = "SecondaryUnitRundown";
        TaskSubType[TaskSubType["SecondaryUnitHotRundown"] = 104] = "SecondaryUnitHotRundown";
        TaskSubType[TaskSubType["OffGradeRundown"] = 105] = "OffGradeRundown";
        TaskSubType[TaskSubType["RecirculationRundown"] = 106] = "RecirculationRundown";
        TaskSubType[TaskSubType["RecirculationMasterRundown"] = 107] = "RecirculationMasterRundown";
        TaskSubType[TaskSubType["Loading"] = 201] = "Loading";
        TaskSubType[TaskSubType["BunkerLoading"] = 202] = "BunkerLoading";
        TaskSubType[TaskSubType["Discharge"] = 301] = "Discharge";
        TaskSubType[TaskSubType["Transfer"] = 401] = "Transfer";
        TaskSubType[TaskSubType["CirculationMixing"] = 402] = "CirculationMixing";
        TaskSubType[TaskSubType["CrudeDraining"] = 501] = "CrudeDraining";
        TaskSubType[TaskSubType["ProductDraining"] = 502] = "ProductDraining";
        TaskSubType[TaskSubType["Mixing"] = 601] = "Mixing";
        TaskSubType[TaskSubType["Settling"] = 701] = "Settling";
        TaskSubType[TaskSubType["Refinery"] = 801] = "Refinery";
    })(TaskSubType = App.TaskSubType || (App.TaskSubType = {}));
    var SecurityMessageType;
    (function (SecurityMessageType) {
        SecurityMessageType[SecurityMessageType["Alarm"] = 1] = "Alarm";
        SecurityMessageType[SecurityMessageType["Notification"] = 2] = "Notification";
    })(SecurityMessageType = App.SecurityMessageType || (App.SecurityMessageType = {}));
    var MessageObjectType;
    (function (MessageObjectType) {
        MessageObjectType[MessageObjectType["Task"] = 1] = "Task";
        MessageObjectType[MessageObjectType["Activity"] = 2] = "Activity";
        MessageObjectType[MessageObjectType["Tank"] = 3] = "Tank";
        MessageObjectType[MessageObjectType["Order"] = 4] = "Order";
    })(MessageObjectType = App.MessageObjectType || (App.MessageObjectType = {}));
    var AlarmObjectType;
    (function (AlarmObjectType) {
        AlarmObjectType[AlarmObjectType["Task"] = 1] = "Task";
        AlarmObjectType[AlarmObjectType["Activity"] = 2] = "Activity";
        AlarmObjectType[AlarmObjectType["Tank"] = 3] = "Tank";
    })(AlarmObjectType = App.AlarmObjectType || (App.AlarmObjectType = {}));
    var NotificationObjectType;
    (function (NotificationObjectType) {
        NotificationObjectType[NotificationObjectType["Task"] = 1] = "Task";
        NotificationObjectType[NotificationObjectType["Activity"] = 2] = "Activity";
        NotificationObjectType[NotificationObjectType["Order"] = 4] = "Order";
    })(NotificationObjectType = App.NotificationObjectType || (App.NotificationObjectType = {}));
    var MessageSourceType;
    (function (MessageSourceType) {
        MessageSourceType[MessageSourceType["TankHighScan"] = 1001] = "TankHighScan";
        MessageSourceType[MessageSourceType["TankMonitoring"] = 1002] = "TankMonitoring";
        MessageSourceType[MessageSourceType["System"] = 1003] = "System";
        //sub task type
        MessageSourceType[MessageSourceType["CrudeUnitFeed"] = 1] = "CrudeUnitFeed";
        MessageSourceType[MessageSourceType["SecondaryUnitFeed"] = 2] = "SecondaryUnitFeed";
        MessageSourceType[MessageSourceType["HotFeed"] = 3] = "HotFeed";
        MessageSourceType[MessageSourceType["CrudeUnitRundown"] = 101] = "CrudeUnitRundown";
        MessageSourceType[MessageSourceType["CrudeUnitHotRundown"] = 102] = "CrudeUnitHotRundown";
        MessageSourceType[MessageSourceType["SecondaryUnitRundown"] = 103] = "SecondaryUnitRundown";
        MessageSourceType[MessageSourceType["SecondaryUnitHotRundown"] = 104] = "SecondaryUnitHotRundown";
        MessageSourceType[MessageSourceType["OffGradeRundown"] = 105] = "OffGradeRundown";
        MessageSourceType[MessageSourceType["RecirculationRundown"] = 106] = "RecirculationRundown";
        MessageSourceType[MessageSourceType["RecirculationMasterRundown"] = 107] = "RecirculationMasterRundown";
        MessageSourceType[MessageSourceType["Loading"] = 201] = "Loading";
        MessageSourceType[MessageSourceType["BunkerLoading"] = 202] = "BunkerLoading";
        MessageSourceType[MessageSourceType["Discharge"] = 301] = "Discharge";
        MessageSourceType[MessageSourceType["Transfer"] = 401] = "Transfer";
        MessageSourceType[MessageSourceType["CrudeDraining"] = 501] = "CrudeDraining";
        MessageSourceType[MessageSourceType["ProductDraining"] = 502] = "ProductDraining";
        MessageSourceType[MessageSourceType["Mixing"] = 601] = "Mixing";
        MessageSourceType[MessageSourceType["Settling"] = 701] = "Settling";
        MessageSourceType[MessageSourceType["Refinery"] = 801] = "Refinery";
    })(MessageSourceType = App.MessageSourceType || (App.MessageSourceType = {}));
    var AlarmSourceType;
    (function (AlarmSourceType) {
        AlarmSourceType[AlarmSourceType["TankHighScan"] = 1001] = "TankHighScan";
        AlarmSourceType[AlarmSourceType["TankMonitoring"] = 1002] = "TankMonitoring";
        AlarmSourceType[AlarmSourceType["System"] = 1003] = "System";
        //sub task type
        AlarmSourceType[AlarmSourceType["CrudeUnitFeed"] = 1] = "CrudeUnitFeed";
        AlarmSourceType[AlarmSourceType["SecondaryUnitFeed"] = 2] = "SecondaryUnitFeed";
        AlarmSourceType[AlarmSourceType["HotFeed"] = 3] = "HotFeed";
        AlarmSourceType[AlarmSourceType["CrudeUnitRundown"] = 101] = "CrudeUnitRundown";
        AlarmSourceType[AlarmSourceType["CrudeUnitHotRundown"] = 102] = "CrudeUnitHotRundown";
        AlarmSourceType[AlarmSourceType["SecondaryUnitRundown"] = 103] = "SecondaryUnitRundown";
        AlarmSourceType[AlarmSourceType["SecondaryUnitHotRundown"] = 104] = "SecondaryUnitHotRundown";
        AlarmSourceType[AlarmSourceType["OffGradeRundown"] = 105] = "OffGradeRundown";
        AlarmSourceType[AlarmSourceType["RecirculationRundown"] = 106] = "RecirculationRundown";
        AlarmSourceType[AlarmSourceType["RecirculationMasterRundown"] = 107] = "RecirculationMasterRundown";
        AlarmSourceType[AlarmSourceType["Loading"] = 201] = "Loading";
        AlarmSourceType[AlarmSourceType["BunkerLoading"] = 202] = "BunkerLoading";
        AlarmSourceType[AlarmSourceType["Discharge"] = 301] = "Discharge";
        AlarmSourceType[AlarmSourceType["Transfer"] = 401] = "Transfer";
        AlarmSourceType[AlarmSourceType["CrudeDraining"] = 501] = "CrudeDraining";
        AlarmSourceType[AlarmSourceType["ProductDraining"] = 502] = "ProductDraining";
        AlarmSourceType[AlarmSourceType["Mixing"] = 601] = "Mixing";
        AlarmSourceType[AlarmSourceType["Settling"] = 701] = "Settling";
        AlarmSourceType[AlarmSourceType["Refinery"] = 801] = "Refinery";
    })(AlarmSourceType = App.AlarmSourceType || (App.AlarmSourceType = {}));
    var NotificationSourceType;
    (function (NotificationSourceType) {
        //sub task type
        NotificationSourceType[NotificationSourceType["CrudeUnitFeed"] = 1] = "CrudeUnitFeed";
        NotificationSourceType[NotificationSourceType["SecondaryUnitFeed"] = 2] = "SecondaryUnitFeed";
        NotificationSourceType[NotificationSourceType["HotFeed"] = 3] = "HotFeed";
        NotificationSourceType[NotificationSourceType["CrudeUnitRundown"] = 101] = "CrudeUnitRundown";
        NotificationSourceType[NotificationSourceType["CrudeUnitHotRundown"] = 102] = "CrudeUnitHotRundown";
        NotificationSourceType[NotificationSourceType["SecondaryUnitRundown"] = 103] = "SecondaryUnitRundown";
        NotificationSourceType[NotificationSourceType["SecondaryUnitHotRundown"] = 104] = "SecondaryUnitHotRundown";
        NotificationSourceType[NotificationSourceType["OffGradeRundown"] = 105] = "OffGradeRundown";
        NotificationSourceType[NotificationSourceType["RecirculationRundown"] = 106] = "RecirculationRundown";
        NotificationSourceType[NotificationSourceType["RecirculationMasterRundown"] = 107] = "RecirculationMasterRundown";
        NotificationSourceType[NotificationSourceType["Loading"] = 201] = "Loading";
        NotificationSourceType[NotificationSourceType["BunkerLoading"] = 202] = "BunkerLoading";
        NotificationSourceType[NotificationSourceType["Discharge"] = 301] = "Discharge";
        NotificationSourceType[NotificationSourceType["Transfer"] = 401] = "Transfer";
        NotificationSourceType[NotificationSourceType["CrudeDraining"] = 501] = "CrudeDraining";
        NotificationSourceType[NotificationSourceType["ProductDraining"] = 502] = "ProductDraining";
        NotificationSourceType[NotificationSourceType["Mixing"] = 601] = "Mixing";
        NotificationSourceType[NotificationSourceType["Settling"] = 701] = "Settling";
        NotificationSourceType[NotificationSourceType["Refinery"] = 801] = "Refinery";
    })(NotificationSourceType = App.NotificationSourceType || (App.NotificationSourceType = {}));
    var SecurityAlarmStatus;
    (function (SecurityAlarmStatus) {
        SecurityAlarmStatus[SecurityAlarmStatus["None"] = 0] = "None";
        SecurityAlarmStatus[SecurityAlarmStatus["NotYetAck"] = 1] = "NotYetAck";
        SecurityAlarmStatus[SecurityAlarmStatus["Acked"] = 2] = "Acked";
    })(SecurityAlarmStatus = App.SecurityAlarmStatus || (App.SecurityAlarmStatus = {}));
    var ScanStatusOption;
    (function (ScanStatusOption) {
        ScanStatusOption[ScanStatusOption["On"] = 1] = "On";
        ScanStatusOption[ScanStatusOption["Off"] = 2] = "Off";
    })(ScanStatusOption = App.ScanStatusOption || (App.ScanStatusOption = {}));
    var AdditiveInjectionMode;
    (function (AdditiveInjectionMode) {
        AdditiveInjectionMode[AdditiveInjectionMode["Auto"] = 0] = "Auto";
        AdditiveInjectionMode[AdditiveInjectionMode["Manual"] = 1] = "Manual";
    })(AdditiveInjectionMode = App.AdditiveInjectionMode || (App.AdditiveInjectionMode = {}));
    var ValveOperationType;
    (function (ValveOperationType) {
        ValveOperationType[ValveOperationType["Undefine"] = 0] = "Undefine";
        ValveOperationType[ValveOperationType["MCS"] = 1] = "MCS";
        ValveOperationType[ValveOperationType["MCR"] = 2] = "MCR";
        ValveOperationType[ValveOperationType["MCF"] = 3] = "MCF";
        ValveOperationType[ValveOperationType["BV"] = 4] = "BV";
        ValveOperationType[ValveOperationType["HV"] = 5] = "HV";
    })(ValveOperationType = App.ValveOperationType || (App.ValveOperationType = {}));
    var MappingType;
    (function (MappingType) {
        MappingType[MappingType["Undefined"] = 0] = "Undefined";
        MappingType[MappingType["AdditiveVessel"] = 1] = "AdditiveVessel";
        MappingType[MappingType["AutoSampler"] = 2] = "AutoSampler";
        MappingType[MappingType["BlendController"] = 3] = "BlendController";
        MappingType[MappingType["Boom"] = 4] = "Boom";
        MappingType[MappingType["CustodyMeter"] = 5] = "CustodyMeter";
        MappingType[MappingType["NDI"] = 6] = "NDI";
        MappingType[MappingType["FlowController"] = 7] = "FlowController";
        MappingType[MappingType["HandController"] = 8] = "HandController";
        MappingType[MappingType["Line"] = 9] = "Line";
        MappingType[MappingType["Microfilter"] = 10] = "Microfilter";
        MappingType[MappingType["Mixer"] = 11] = "Mixer";
        MappingType[MappingType["ProcessUnit"] = 12] = "ProcessUnit";
        MappingType[MappingType["Pump"] = 13] = "Pump";
        MappingType[MappingType["RatioController"] = 14] = "RatioController";
        MappingType[MappingType["Sink"] = 15] = "Sink";
        MappingType[MappingType["Spade"] = 16] = "Spade";
        MappingType[MappingType["Tank"] = 17] = "Tank";
        MappingType[MappingType["Valve"] = 18] = "Valve";
        MappingType[MappingType["Wharf"] = 19] = "Wharf";
        MappingType[MappingType["DrainingStart"] = 20] = "DrainingStart";
        MappingType[MappingType["DrainingStop"] = 21] = "DrainingStop";
        MappingType[MappingType["TankTemperature"] = 22] = "TankTemperature";
        MappingType[MappingType["PumpAmpere"] = 23] = "PumpAmpere";
        MappingType[MappingType["CommunicationError"] = 24] = "CommunicationError";
        MappingType[MappingType["SMReset"] = 25] = "SMReset";
        MappingType[MappingType["WharfTrip"] = 26] = "WharfTrip";
        MappingType[MappingType["NSW"] = 27] = "NSW";
        MappingType[MappingType["PumpNSW"] = 28] = "PumpNSW";
        MappingType[MappingType["CustodyMeterNSW"] = 29] = "CustodyMeterNSW";
        MappingType[MappingType["DigitalSwitchNDI"] = 30] = "DigitalSwitchNDI";
        MappingType[MappingType["DigitalSwitchNSW"] = 31] = "DigitalSwitchNSW";
        //AdditiveVesselGSV = 32,
        MappingType[MappingType["PumpTemperature"] = 33] = "PumpTemperature";
        MappingType[MappingType["DailyTankStock"] = 50] = "DailyTankStock";
        MappingType[MappingType["HighScanTankStock"] = 51] = "HighScanTankStock";
        MappingType[MappingType["TankPressure"] = 52] = "TankPressure";
        MappingType[MappingType["OtherInstrument"] = 999] = "OtherInstrument";
    })(MappingType = App.MappingType || (App.MappingType = {}));
    var TSS;
    (function (TSS) {
        TSS[TSS["USE"] = 1] = "USE";
        TSS[TSS["BACKUP"] = 2] = "BACKUP";
        TSS[TSS["INCOMING"] = 3] = "INCOMING";
        TSS[TSS["RELEASED"] = 4] = "RELEASED";
    })(TSS = App.TSS || (App.TSS = {}));
    var ActivityPagingType;
    (function (ActivityPagingType) {
        ActivityPagingType[ActivityPagingType["None"] = 0] = "None";
        ActivityPagingType[ActivityPagingType["Previous"] = 1] = "Previous";
        ActivityPagingType[ActivityPagingType["Next"] = 2] = "Next";
    })(ActivityPagingType = App.ActivityPagingType || (App.ActivityPagingType = {}));
    var FRMessageConstants = /** @class */ (function () {
        function FRMessageConstants() {
        }
        FRMessageConstants.TASK_PEND_SUCCEEDED = "MSG_6_6_2254";
        FRMessageConstants.TASK_COMPLETE_SUCCEEDED = "MSG_6_6_2255";
        FRMessageConstants.CHANGE_SPECIFIED_STOP_COND_SUCCEEDED = "MSG_6_6_2256";
        FRMessageConstants.ACTIVITY_START_REQUEST_SUCCEEDED = "MSG_6_6_2259";
        FRMessageConstants.ACTIVITY_FINISH_REQUEST_SUCCEEDED = "MSG_6_6_2260";
        FRMessageConstants.RATIO_CHANGE_SUCCEEDED = "MSG_6_6_2261";
        FRMessageConstants.PATH_CANCEL_SUCCEEDED = "MSG_6_6_2262";
        FRMessageConstants.PATH_RELEASE_SUCCEEDED = "MSG_6_6_2263";
        FRMessageConstants.PATH_CONFIRM_SUCCEEDED = "MSG_6_6_2264";
        FRMessageConstants.PATH_NOMINATE_SUCCEEDED = "MSG_6_6_2265";
        FRMessageConstants.ACTIVITY_CANCEL_SUCCEEDED = "MSG_6_6_2266";
        FRMessageConstants.SPIKING_TANK_ADDITION_SUCCEEDED = "MSG_6_6_2267";
        FRMessageConstants.SPIKING_TANK_DELETION_SUCCEEDED = "MSG_6_6_2268";
        FRMessageConstants.SPIKING_TANK_RELEASE_SUCCEEDED = "MSG_6_6_2269";
        FRMessageConstants.SPIKING_TANK_SWING_START_SUCCEEDED = "MSG_6_6_2270";
        FRMessageConstants.PUMP_ADDITION_SUCCEEDED = "MSG_6_6_2271";
        FRMessageConstants.PUMP_DELETION_SUCCEEDED = "MSG_6_6_2272";
        return FRMessageConstants;
    }());
    App.FRMessageConstants = FRMessageConstants;
})(App || (App = {}));
var EnterpriseSolution;
(function (EnterpriseSolution) {
    ...
    EnterpriseSolution.Common = Common;
