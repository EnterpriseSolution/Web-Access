namespace Matrix.Finance {
    export interface CurrencyLedgerSummaryRow {
        Recnum?: number;
        AcctNo?: string;
        Period?: string;
        FiscalYear?: number;
    ...
    export namespace CurrencyLedgerSummaryRow {
        export const idProperty = 'Recnum';
        export const nameProperty = 'AcctNo';
        export const localTextPrefix = 'Finance.CurrencyLedgerSummary';
        ...
        export namespace Fields {
            ...
            export declare const LtotalDebit: string;
            export declare const LtotalCredit: string;
            export declare const LbalBeg: string;
            export declare const LbalBegSign: string;
            export declare const LbalEnd: string;
            export declare const LbalEndSign: string;
