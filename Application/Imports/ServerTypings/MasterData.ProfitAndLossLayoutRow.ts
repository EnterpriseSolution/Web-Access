namespace Matrix.MasterData {
    export interface ProfitAndLossLayoutRow {
        Recnum?: number;
        LineNo?: number;
        LineType?: string;
        LineSkip?: number;
    ...
    export namespace ProfitAndLossLayoutRow {
        export const idProperty = 'Recnum';
        export const nameProperty = 'LineType';
        export const localTextPrefix = 'MasterData.ProfitAndLossLayout';
        ...
        export namespace Fields {
            ...
            export declare const CellValuePeriod: string;
            export declare const CellValueFiscalYear: string;
        }
