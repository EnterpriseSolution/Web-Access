namespace Matrix.Finance {
    export interface AccountsReceivableInvoiceDetailRow {
        Recnum?: number;
        InvoiceNo?: string;
        LineNo?: number;
        ItemNo?: string;
    ...
    export namespace AccountsReceivableInvoiceDetailRow {
        export const idProperty = 'Recnum';
        export const nameProperty = 'InvoiceNo';
        export const localTextPrefix = 'Finance.AccountsReceivableInvoiceDetail';
        ...
        export namespace Fields {
            ...
            export declare const ShipmentEntryNo: string;
            ...
            export declare const OrderLineNo: string;
            export declare const PriceAmt: string;
            export declare const NetPrice: string;
            export declare const AcctLdisc: string;
            export declare const ShipItemAmt: string;
            export declare const LshipItemAmt: string;
