namespace Matrix.Finance {
    ...
    export namespace CurrencyBalanceRow {
        export const idProperty = 'Recnum';
        export const nameProperty = 'AcctNo';
        export const localTextPrefix = 'Finance.CurrencyBalance';
        ...
        export namespace Fields {
            ...
            export declare const ForexBalance: string;
            export declare const ForexSign: string;
            export declare const LocalBalance: string;
            export declare const LocalSign: string;
