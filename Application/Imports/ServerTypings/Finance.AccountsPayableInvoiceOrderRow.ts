namespace Matrix.Finance {
    export interface AccountsPayableInvoiceOrderRow {
        Recnum?: number;
        ControlNo?: string;
        GrnNo?: string;
        OrderNo?: string;
    ...
    export namespace AccountsPayableInvoiceOrderRow {
        export const idProperty = 'Recnum';
        export const nameProperty = 'ControlNo';
        export const localTextPrefix = 'Finance.AccountsPayableInvoiceOrder';
