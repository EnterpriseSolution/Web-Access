namespace Matrix
{
    ...
    { 
        ...
        private static void RunMigrations(string databaseKey)
        {
            ...
            // remove these lines if you want Matrix migrations to run on your DB.
            ...
            string databaseType = "SqlServer";// isOracle ? "OracleManaged" : serverType;
            ...
            using (var sw = new StringWriter())
            {
                ...
                var runner = new RunnerContext(announcer)
                {
                    ...
                    Namespace = "Matrix.Migrations." + databaseKey + "DB",
                    Timeout = 90
                };
