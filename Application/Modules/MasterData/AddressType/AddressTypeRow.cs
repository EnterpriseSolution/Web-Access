...
namespace Matrix.MasterData.Entities
{
    ...
    [ConnectionKey("MasterData"), TableName("[dbo].[SLTADD]")]
    ...
    public sealed class AddressTypeRow : Row, IIdRow, INameRow
    {
        ...
        [DisplayName("Address Type"), Column("ADDRESS_TYPE"), Size(12), PrimaryKey, QuickSearch]
        ...
        public class RowFields : RowFieldsBase
        {
            ...
            public RowFields()
                : base()
            {
                LocalTextPrefix = "MasterData.AddressType";
            }
        }
    }
}
