...
namespace Matrix.MasterData.Entities
{
    ...
    [ConnectionKey("MasterData"), TableName("[dbo].[SLTLNK]")]
    [DisplayName("Customer Link Type"), InstanceName("Customer Link Type"), TwoLevelCached]   
    public sealed class CustomerLinkTypeRow : Row, IIdRow, INameRow
    {
        ...
        [DisplayName("Link Type"), Column("LINK_TYPE"), Size(12), PrimaryKey, QuickSearch]
        public String LinkType
        {
            get { return Fields.LinkType[this]; }
            set { Fields.LinkType[this] = value; }
        }
        ...
        {
            get { return Fields.LinkType; }
        }

        public static readonly RowFields Fields = new RowFields().Init();

        public CustomerLinkTypeRow()
            : base(Fields)
        {
        }
        ...
        public class RowFields : RowFieldsBase
        {
            ...
            public RowFields()
                : base()
            {
                LocalTextPrefix = "MasterData.CustomerLinkType";
            }
        }
    }
}
