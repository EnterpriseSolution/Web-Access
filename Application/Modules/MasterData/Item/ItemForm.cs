...
namespace Matrix.MasterData.Forms
{
    ...
    public class ItemForm
    {
        ...
        [Category(CategoryName.Specification)]
        ...
        [Category(CategoryName.Quantity)]
        ...
        [Category(CategoryName.Analysis)]
