...
namespace Matrix.MasterData.Entities
{
    ...
    [ConnectionKey("MasterData"), TableName("[dbo].[SLTCON]")]
    [DisplayName("Contact Type"), InstanceName("Contact Type"), TwoLevelCached]   
    public sealed class ContactTypeRow : Row, IIdRow, INameRow
    {
        ...
        [DisplayName("Contact Type"), Column("CONTACT_TYPE"), Size(12), PrimaryKey, QuickSearch]
        public String ContactType
        {
            get { return Fields.ContactType[this]; }
            set { Fields.ContactType[this] = value; }
        }
        ...
        public class RowFields : RowFieldsBase
        {
            ...
            public StringField ContactType;
            ...
            public RowFields()
                : base()
            {
                LocalTextPrefix = "MasterData.ContactType";
            }
        }
    }
}
