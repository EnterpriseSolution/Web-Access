...
namespace Matrix.MasterData.Entities
{
    ...
    [ConnectionKey("Finance"), TableName("[dbo].[GLBUDG]")]
    [DisplayName("Account Budget"), InstanceName("Account Budget"), TwoLevelCached]   
    public sealed class AccountBudgetRow : Row, IIdRow, INameRow
    {
        ...
        [DisplayName("Control Debit"), Column("CONTROL_DEBIT"), Size(1)]
        public String ControlDebit
        {
            get { return Fields.ControlDebit[this]; }
            set { Fields.ControlDebit[this] = value; }
        }

        [DisplayName("Control Credit"), Column("CONTROL_CREDIT"), Size(1)]
        public String ControlCredit
        {
        ...
        public class RowFields : RowFieldsBase
        {
            ...
            public StringField ControlDebit;
            public StringField ControlCredit;
            ...
            public RowFields()
                : base()
            {
                LocalTextPrefix = "Finance.AccountBudget";
            }
        }
    }
}
