...
namespace Matrix.MasterData.Entities
{
    ...
    [ConnectionKey("MasterData"), TableName("[dbo].[GLFINB]")]
    [DisplayName("Balance Sheet Layout"), InstanceName("Balance Sheet Layout"), TwoLevelCached]   
    public sealed class BalanceSheetLayoutRow : Row, IIdRow, INameRow
    {
        ...
        [DisplayName("Cell Value Begin"), Column("CELL_VALUE_BEGIN"), Size(6)]
        public String CellValueBegin
        {
            get { return Fields.CellValueBegin[this]; }
            set { Fields.CellValueBegin[this] = value; }
        }

        [DisplayName("Cell Value End"), Column("CELL_VALUE_END"), Size(6)]
        public String CellValueEnd
        {
            get { return Fields.CellValueEnd[this]; }
            set { Fields.CellValueEnd[this] = value; }
        }
        ...
        public class RowFields : RowFieldsBase
        {
            ...
            public StringField CellValueBegin;
            public StringField CellValueEnd;

            public RowFields()
                : base()
            {
                LocalTextPrefix = "MasterData.BalanceSheetLayout";
            }
        }
    }
}
