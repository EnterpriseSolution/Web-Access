...
namespace Matrix.MasterData.Forms
{
    ...
    [FormScript("MasterData.WorkCentre")]
    [BasedOnRow(typeof(Entities.WorkCentreRow))]
    public class WorkCentreForm
    {
        ...
        [Tab(TabName.Restrict)]
        [Category(CategoryName.Restrict)]
