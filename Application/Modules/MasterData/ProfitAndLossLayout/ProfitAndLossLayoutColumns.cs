...
// File:  ProfitAndLossLayoutColumns.cs
...
namespace Matrix.MasterData.Columns
{
    ...
    [ColumnsScript("MasterData.ProfitAndLossLayout")]
    [BasedOnRow(typeof(Entities.ProfitAndLossLayoutRow))]
    public class ProfitAndLossLayoutColumns
    {
        ...
        //public String CellValuePeriod { get; set; }
        //public String CellValueFiscalYear { get; set; }
    }
}