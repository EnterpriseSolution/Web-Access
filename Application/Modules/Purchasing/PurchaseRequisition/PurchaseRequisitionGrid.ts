...
namespace Matrix.Purchasing {
    ...
    export class PurchaseRequisitionGrid extends Serenity.EntityGrid<PurchaseRequisitionRow, any> {
        protected getColumnsKey() { return 'Purchasing.PurchaseRequisition'; }
