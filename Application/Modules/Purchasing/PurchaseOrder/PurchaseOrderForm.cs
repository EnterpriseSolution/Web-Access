...
namespace Matrix.Purchasing.Forms
{
    ...
    [FormScript("Purchasing.PurchaseOrder")]
    ...
    public class PurchaseOrderForm
    {
        ...
        public List<PurchaseOrderDetailRow> ItemDetailList { get; set; }
        ...
        [DisplayName("Gross Purchase Tax %")]
        public Decimal TdiscPcent { get; set; }

        [DisplayName("Trade Dicount %")]
        public Decimal TotTdiscAmt { get; set; }

        [DisplayName("Gross Purchse Tax Amt")]
        ...
        [Category(CategoryName.DepositRequirement)]
        ...
        [DisplayName("Payee"),TextAreaEditor(Rows = 4)]
