...
namespace Matrix.Administration.Repositories
{
    ...
    [Matrix.Modules.Common.RepositoryService("UserRepository")]
    public partial class UserRepository : Matrix.Modules.Common.RepositoryBase
    {
        ...
        public static string ValidatePassword(string username, string password, bool isNewUser)
        {
            ...
            if (password == null)
                throw new ValidationError("PasswordLength", "Password",String.Format(Texts.Validation.MinRequiredPasswordLength, 5));
