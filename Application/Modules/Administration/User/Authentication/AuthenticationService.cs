...
namespace Matrix.Administration
{
    ...
    {
        public IUserDefinition Validate(ref string username, string password, string companyCode)
        {
            ...
            var user = Dependency.Resolve<IUserRetrieveService>().ById(username, companyCode) as UserDefinition;
