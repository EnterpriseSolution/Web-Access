...
namespace Matrix.Sales.Forms
{
    ...
    public class ShipmentForm
    {
        ...
        [Category(CategoryName.CurrencyAndTerms)]
        ...
        [Category(CategoryName.DepositTracking)]
        ...
        [Tab(TabName.OrderSummary)]
        public Boolean ManualShipmentDetail { get; set; }
        public String RefCompanyCode { get; set; }


        [Tab(TabName.ShipmentDetails)]
        [ShipmentDetailEditor]
        public List<ShipmentDetailRow> DetailList { get; set; }


        [Tab(TabName.ShipmentCharges)]
