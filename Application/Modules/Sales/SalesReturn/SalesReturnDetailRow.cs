...
namespace Matrix.Sales.Entities
{
    ...
    [ConnectionKey("Sales"), TableName("[dbo].[SLRETD]")]
    [DisplayName("Sales Return Detail"), InstanceName("Sales Return Detail"), TwoLevelCached]   
    public sealed class SalesReturnDetailRow : Row, IIdRow, INameRow
    {
        ...
        [DisplayName("Ref No"), Column("REF_NO"), Size(16), PrimaryKey, ForeignKey("[dbo].[SLRETH]", "REF_NO"), LeftJoin("jRefNo"), QuickSearch, TextualField("RefNoPosted")]
        public String RefNo
        {
        ...
        [DisplayName("Ref No Shipment Ref"), Expression("jRefNo.[SHIPMENT_REF]")]
        public String RefNoShipmentRef
        {
            get { return Fields.RefNoShipmentRef[this]; }
            set { Fields.RefNoShipmentRef[this] = value; }
        }
        ...
        [DisplayName("Ref No Return Only"), Expression("jRefNo.[RETURN_ONLY]")]
        public String RefNoReturnOnly
        {
            get { return Fields.RefNoReturnOnly[this]; }
            set { Fields.RefNoReturnOnly[this] = value; }
        }
        ...
        public class RowFields : RowFieldsBase
        {
            ...
            public StringField RefNoShipmentRef;
            ...
            public StringField RefNoReturnOnly;
            ...
            public RowFields()
                : base()
            {
                LocalTextPrefix = "Sales.SalesReturnDetail";
            }
        }
    }
}
