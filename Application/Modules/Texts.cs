    ...
    public static partial class Texts
    {
        ...
        public static class Forms
        {
            public static class Membership
            {
                ...
                {
                    public static LocalText EmailSubject = "Reset Your Matrix Password";
                ...
                {
                    public static LocalText FormTitle = "Welcome to Enterprsie Solution";
                ...
                {
                    public static LocalText ActivateEmailSubject = "Activate Your Matrix Account";
                    ...
                    public static LocalText FormTitle = "Sign up for Matrix";
        ...
        public static class Navigation
        {
            ...
            public static LocalText SiteTitle = "Enterprise Solution";
        }
        ...
        public static class Site
        {
            ...
            {
                public static LocalText FooterCopyright = "Company: 上海亚太计算机信息系统有限公司[STD]";

                public static LocalText FooterCompany
                {

                    get
                    {
                        if (string.IsNullOrWhiteSpace(Authorization.CompanyCode))
                            return string.Empty;

                        else
                            return string.Format("Company: {0}[{1}]", Authorization.CompanyName,Authorization.CompanyCode);
                    }
                }
                    
                public static LocalText FooterUser = "User: Administrator";
                public static LocalText FooterPeriod = "Period: 2018/01";
                
                public static LocalText FooterInfo = "Enterprise Solution Limited";
                public static LocalText FooterRights = "All rights reserved.";
                public static LocalText GeneralSettings = "GeneralInformation Settings";
