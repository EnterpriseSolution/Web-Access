...
// File:  CurrencyLedgerSummaryRow.cs
...
namespace Matrix.Finance.Entities
{
    ...
    [ConnectionKey("Finance"), TableName("[dbo].[GLLEDS]")]
    [DisplayName("Currency Ledger Summary"), InstanceName("Currency Ledger Summary"), TwoLevelCached]   
    public sealed class CurrencyLedgerSummaryRow : Row, IIdRow, INameRow
    {
        ...
        [DisplayName("Ltotal Debit"), Column("LTOTAL_DEBIT"), Size(16), Scale(2)]
        public Decimal? LtotalDebit
        {
            get { return Fields.LtotalDebit[this]; }
            set { Fields.LtotalDebit[this] = value; }
        }

        [DisplayName("Ltotal Credit"), Column("LTOTAL_CREDIT"), Size(16), Scale(2)]
        public Decimal? LtotalCredit
        {
            get { return Fields.LtotalCredit[this]; }
            set { Fields.LtotalCredit[this] = value; }
        }

        [DisplayName("Lbal Beg"), Column("LBAL_BEG"), Size(16), Scale(2)]
        public Decimal? LbalBeg
        {
            get { return Fields.LbalBeg[this]; }
            set { Fields.LbalBeg[this] = value; }
        }

        [DisplayName("Lbal Beg Sign"), Column("LBAL_BEG_SIGN"), Size(6)]
        public String LbalBegSign
        {
            get { return Fields.LbalBegSign[this]; }
            set { Fields.LbalBegSign[this] = value; }
        }

        [DisplayName("Lbal End"), Column("LBAL_END"), Size(16), Scale(2)]
        public Decimal? LbalEnd
        {
            get { return Fields.LbalEnd[this]; }
            set { Fields.LbalEnd[this] = value; }
        }

        [DisplayName("Lbal End Sign"), Column("LBAL_END_SIGN"), Size(6)]
        public String LbalEndSign
        {
            get { return Fields.LbalEndSign[this]; }
            set { Fields.LbalEndSign[this] = value; }
        }
        ...
        public CurrencyLedgerSummaryRow()
            : base(Fields)
        {
        }
        ...
        public class RowFields : RowFieldsBase
        {
            ...
            public DecimalField LtotalDebit;
            public DecimalField LtotalCredit;
            public DecimalField LbalBeg;
            public StringField LbalBegSign;
            public DecimalField LbalEnd;
            public StringField LbalEndSign;
            ...
            public RowFields()
                : base()
            {
                LocalTextPrefix = "Finance.CurrencyLedgerSummary";
            }
        }
    }
}
