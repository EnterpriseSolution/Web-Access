...
namespace Matrix.Finance.Entities
{
    ...
    [ConnectionKey("Finance"), TableName("[dbo].[GLCLDG]")]
    [DisplayName("Currency Ledger"), InstanceName("Currency Ledger"), TwoLevelCached]   
    public sealed class CurrencyLedgerRow : Row, IIdRow, INameRow
    {
        ...
        [DisplayName("Begin"), Column("FOREX_BEG"), Size(16), Scale(2)]
        public Decimal? ForexBeg
        {
            get { return Fields.ForexBeg[this]; }
            set { Fields.ForexBeg[this] = value; }
        }

        [DisplayName("Begin Sign"), Column("FOREX_BEG_SIGN"), Size(6)]
        public String ForexBegSign
        {
            get { return Fields.ForexBegSign[this]; }
            set { Fields.ForexBegSign[this] = value; }
        }

        [DisplayName("Debit"), Column("FOREX_DEBIT"), Size(16), Scale(2)]
        public Decimal? ForexDebit
        {
            get { return Fields.ForexDebit[this]; }
            set { Fields.ForexDebit[this] = value; }
        }

        [DisplayName("Credit"), Column("FOREX_CREDIT"), Size(16), Scale(2)]
        public Decimal? ForexCredit
        {
            get { return Fields.ForexCredit[this]; }
            set { Fields.ForexCredit[this] = value; }
        }

        [DisplayName("End"), Column("FOREX_END"), Size(16), Scale(2)]
        public Decimal? ForexEnd
        {
            get { return Fields.ForexEnd[this]; }
            set { Fields.ForexEnd[this] = value; }
        }

        [DisplayName("End Sign"), Column("FOREX_END_SIGN"), Size(6)]
        public String ForexEndSign
        {
            get { return Fields.ForexEndSign[this]; }
            set { Fields.ForexEndSign[this] = value; }
        }

        [DisplayName("Begin"), Column("LOCAL_BEG"), Size(16), Scale(2)]
        public Decimal? LocalBeg
        {
            get { return Fields.LocalBeg[this]; }
            set { Fields.LocalBeg[this] = value; }
        }

        [DisplayName("Begin Sign"), Column("LOCAL_BEG_SIGN"), Size(6)]
        public String LocalBegSign
        {
            get { return Fields.LocalBegSign[this]; }
            set { Fields.LocalBegSign[this] = value; }
        }

        [DisplayName("Debit"), Column("LOCAL_DEBIT"), Size(16), Scale(2)]
        ...
        [DisplayName("Credit"), Column("LOCAL_CREDIT"), Size(16), Scale(2)]
        ...
        [DisplayName("End"), Column("LOCAL_END"), Size(16), Scale(2)]
        public Decimal? LocalEnd
        {
            get { return Fields.LocalEnd[this]; }
            set { Fields.LocalEnd[this] = value; }
        }

        [DisplayName("End Sign"), Column("LOCAL_END_SIGN"), Size(7)]
        public String LocalEndSign
        {
            get { return Fields.LocalEndSign[this]; }
            set { Fields.LocalEndSign[this] = value; }
        }
        ...
        public class RowFields : RowFieldsBase
        {
            ...
            public DecimalField ForexBeg;
            public StringField ForexBegSign;
            public DecimalField ForexDebit;
            public DecimalField ForexCredit;
            public DecimalField ForexEnd;
            public StringField ForexEndSign;
            public DecimalField LocalBeg;
            public StringField LocalBegSign;
            public DecimalField LocalDebit;
            public DecimalField LocalCredit;
            public DecimalField LocalEnd;
            public StringField LocalEndSign;
            ...
            public RowFields()
                : base()
            {
                LocalTextPrefix = "Finance.CurrencyLedger";
            }
        }
    }
}
