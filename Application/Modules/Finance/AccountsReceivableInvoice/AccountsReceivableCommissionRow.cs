...
// File:  AccountsReceivableCommissionRow.cs
...
namespace Matrix.Finance.Entities
{
    ...
    [ConnectionKey("Finance"), TableName("[dbo].[ARINVM]")]
    [DisplayName("Accounts Receivable Commission"), InstanceName("Accounts Receivable Commission"), TwoLevelCached]   
    public sealed class AccountsReceivableCommissionRow : Row, IIdRow, INameRow
    {
        ...
        [DisplayName("Salesman"), Column("SALESMAN"), Size(12), PrimaryKey]
        ...
        [DisplayName("Salesman Name"), Column("SALESMAN_NAME"), Size(50)]
        ...
        [DisplayName("Rate"), Column("RATE"), Size(6), Scale(2), NotNull]
        public Decimal? Rate
        {
        ...
        public AccountsReceivableCommissionRow()
            : base(Fields)
        {
        }
        ...
        public class RowFields : RowFieldsBase
        {
            ...
            public RowFields()
                : base()
            {
                LocalTextPrefix = "Finance.AccountsReceivableCommission";
            }
        }
    }
}
