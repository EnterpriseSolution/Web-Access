...
// File:  AccountsReceivableInvoiceDetailColumns.cs
...
namespace Matrix.Finance.Columns
{
    ...
    [ColumnsScript("Finance.AccountsReceivableInvoiceDetail")]
    [BasedOnRow(typeof(Entities.AccountsReceivableInvoiceDetailRow))]
    public class AccountsReceivableInvoiceDetailColumns
    {
