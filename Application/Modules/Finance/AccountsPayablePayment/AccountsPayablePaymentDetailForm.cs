...
// File:  AccountsPayablePaymentDetailForm.cs
...
namespace Matrix.Finance.Forms
{
    ...
    [FormScript("Finance.AccountsPayablePaymentDetail")]
    [BasedOnRow(typeof(Entities.AccountsPayablePaymentDetailRow))]
    public class AccountsPayablePaymentDetailForm
    {
        public String RefNo { get; set; }
        public String InvoCtrlNo { get; set; }
