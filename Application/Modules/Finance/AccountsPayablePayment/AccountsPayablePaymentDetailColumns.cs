...
// File:  AccountsPayablePaymentDetailColumns.cs
...
namespace Matrix.Finance.Columns
{
    ...
    [ColumnsScript("Finance.AccountsPayablePaymentDetail")]
    [BasedOnRow(typeof(Entities.AccountsPayablePaymentDetailRow))]
    public class AccountsPayablePaymentDetailColumns
    {
        [EditLink, DisplayName("Id"), AlignRight]
        public Decimal Recnum { get; set; }
        [EditLink]
        public String RefNoDeposit { get; set; }
        public String InvoCtrlNoMiscellaneous { get; set; }
