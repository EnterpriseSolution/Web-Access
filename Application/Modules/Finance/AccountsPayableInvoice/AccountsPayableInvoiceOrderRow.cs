...
// File:  AccountsPayableInvoiceOrderRow.cs
...
namespace Matrix.Finance.Entities
{
    ...
    [ConnectionKey("Finance"), TableName("[dbo].[APINVO]")]
    [DisplayName("Accounts Payable Invoice Order"), InstanceName("Accounts Payable Invoice Order"), TwoLevelCached]   
    public sealed class AccountsPayableInvoiceOrderRow : Row, IIdRow, INameRow
    {
        ...
        public AccountsPayableInvoiceOrderRow()
            : base(Fields)
        {
        }
        ...
        public class RowFields : RowFieldsBase
        {
            ...
            public RowFields()
                : base()
            {
                LocalTextPrefix = "Finance.AccountsPayableInvoiceOrder";
            }
        }
    }
}
