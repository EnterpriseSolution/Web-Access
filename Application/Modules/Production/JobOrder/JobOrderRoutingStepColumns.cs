...
// File:  JobOrderRoutingStepColumns.cs
...
namespace Matrix.Production.Columns
{
    ...
    [ColumnsScript("Production.JobOrderRoutingStep")]
    [BasedOnRow(typeof(Entities.JobOrderRoutingStepRow))]
    public class JobOrderRoutingStepColumns
    {
        [EditLink, DisplayName("Id"), AlignRight]
        public Decimal Recnum { get; set; }
        [EditLink]
        public String JobNoPosted { get; set; }
