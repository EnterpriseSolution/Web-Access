        ...
        where TOptions : class, new()
    {
        ...
        protected void CreatePager()
        {
            ...
            ((dynamic)pagerDiv).slickPager(new
            {
                ...
                rowsPerPage = 20,
                rowsPerPageOptions = new int[] { 20,30,50,100, 500, 2500 }
                //Enterprise Solution
            });
        }
        ...
        public QuickFilter<DateEditor, DateTimeEditorOptions> DateRangeQuickFilter(string field, string title = null)
        {
            ...
            return new QuickFilter<DateEditor, DateTimeEditorOptions>
            {
                ...
                Handler = args =>
                {
                    ...
                    {
                        active1 = false;
                        Q.NotifyWarning("Please enter a valid date.");
                ...
                this.quickFiltersDiv.Find(".quick-filter-item").Each((i, e) =>
                {
                    ...
                    if (flags.QuickFilterText == true && J(e).HasClass("quick-filter-active"))
                    {
                        ...
                        if (!string.IsNullOrEmpty(displayText))
                        {
                            ...
                            {
                                settings.QuickFilterText += " " + ("and" ?? "and") + " ";
