...
namespace Serenity
{
        ...
        where TOptions: class, new()
    {
        ...
        protected override List<ToolButton> GetToolbarButtons()
        {
            ...
            list.Add(new ToolButton
            {
                Title = "Apply",//2018/02/02 add text Enterprise Solution
                Hint = "Apply Changes",
            ...
            list.Add(new ToolButton
            {
                ...
                OnClick = delegate
                {
                    Q.Confirm("Delete record?", delegate
                    {
            ...
            list.Add(new ToolButton
            {
                ...
                OnClick = delegate
                {
                    if (self.IsDeleted)
                    {
                        Q.Confirm("Undelete record?", delegate()
                        {
        ...
        protected virtual void UpdateInterface()
        {
            ...
            if (localizationButton != null)
            {
                ...
                localizationButton.Find(".button-inner").Text(IsLocalizationMode ? "Back to Form" :"Localization");
            }
            ...
            if (saveAndCloseButton != null)
            {
                ...
                saveAndCloseButton.Find(".button-inner").Text(IsNew ? "Save" : "Update");
            }
