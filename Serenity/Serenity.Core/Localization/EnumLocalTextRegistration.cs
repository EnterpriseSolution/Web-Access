...
#else
        public static void Initialize(IEnumerable<Assembly> assemblies,string languageID = LocalText.InvariantLanguageID, ILocalTextRegistry registry = null)
#endif
        {
            ...
            //2018/02/08 here do not get Serenity.Script.UI and Serenity.Script.Imports because its has different runtime.
