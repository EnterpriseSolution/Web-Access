...
namespace Serenity.Data
{
    ...
    public static class EntityQueryExtensions
    {
        ...
        public static T Set<T>(this T self, IField field, object value) where T : ISetFieldByStatement
        {
            ...
            if (fld.CustomAttributes != null && fld.CustomAttributes.OfType<BoolStringConverterAttribute>().Any())
            {
                bool entityValue = Convert.ToBoolean(value);
                convertValue = entityValue ? "Y" : "N";
            }

            var param = self.AddParam(convertValue);
            self.SetTo(field.Name, param.Name);
            return self;
        }
    }

    public class BoolStringConverterAttribute : Attribute
    {
        public BoolStringConverterAttribute()
        {
