...
namespace Serenity.PropertyGrid
{
    public partial class PropertyItemHelper
    {
        ...
        public static PropertyItem GetCustomFieldPropertyItem(ICustomFieldDefinition definition, Field basedOnField)
        {
            ...
            {
                if (basedOnField is StringField && basedOnField.Size > 0)
                {
            ...
            if (definition.Size != 0 && definition.FieldType == CustomFieldType.String)
            {
            ...
            if (editorOptionsJson != null && editorOptionsJson.StartsWith("{"))
            {
