...
declare namespace App {
    ...
    enum ProcessUnitType {
        Undefine = 0,
        Curede = 1,
        Secondary = 2,
    }
    enum IsShutdownOption {
        Undefine = 0,
        Normal = 1,
        Shutdown = 2,
    }
    ...
    enum RefineryTransferSourceDestinationType {
        Tank = 1,
        Sink = 2,
    }
    enum ActivityType {
    ...
    enum OperationModeDestinationType {
        Undefine = 0,
        SD = 1,
        Tank = 2,
        ProcessUnit = 3,
    ...
    enum PathSelectRuleType {
        None = 0,
        Restriction = 1,
        PrioritizationSequence = 2,
        LineSegment = 3,
    }
    enum PathSelectRuleNOOption {
        None = 0,
        ExcludeLine = 1,
        LineService = 2,
        ExcludeLineType = 3,
    ...
    enum PathSelectionModeOption {
        Available = 1,
        Possible = 2,
        Feasible = 3,
    }
    enum PreferredPathOption {
        None = 0,
        LastUsed = 1,
        MostUsed = 2,
    }
    enum PathSelectionStepNo {
        DischargeHeader = 1,
        Discharge = 2,
        SuctionPath = 3,
        Pump = 4,
        ...
        IndCrudeSpiking = 25,
        SlopSpiking = 29,
        RecirculationSpiking = 33,
        RundownSpiking = 103,
        Precanned = 12,
    }
    class Format {
        static ONUMBER: string;
        static ODATE: string;
    }
    class FormatValue {
        static ONUMBER: string;
    ...
    class MasterDataType {
        static ProductPool: string;
        static ProductGroup: string;
        static Product: string;
        static ProductProperty: string;
        static ProductPropertyData: string;
        static BlendProProductPropertyDataMapping: string;
        static Crude: string;
        static CrudeProductMapping: string;
        static Additive: string;
        static ProductAdditiveMapping: string;
        static AdditiveVessel: string;
        static AutoSampler: string;
        static BlendController: string;
        static Boom: string;
        static DigitalSwitch: string;
        static HandController: string;
        static Line: string;
        static Meter: string;
        static Microfilter: string;
        static PumpHouse: string;
        static Pump: string;
        static PumpMeterMapping: string;
        static RatioController: string;
        static ProcessUnit: string;
        static ProcessUnitProductPoolMapping: string;
        static RundownStream: string;
        static RundownStreamProductPoolMapping: string;
        static RundownCut: string;
        static RundownCutProductGroupMapping: string;
        static Ship: string;
        static Sink: string;
        static Spade: string;
        static Tank: string;
        ...
        static Wharf: string;
        static Mixer: string;
        static TankArm: string;
        static TankMixerActivation: string;
        static ProductCompatibility: string;
        static CustodyMeter: string;
        static PipelineProductVT: string;
        static PipelineProductMapping: string;
        static CustodyMeterVT: string;
        static CustodyMeterVTMapping: string;
        static FlowController: string;
    }
    enum SwingPatternOption {
        Original = 1,
        SWPattern1 = 2,
        SWPattern2 = 3,
        SWPattern3 = 4,
    }
    enum ActionSourceOption {
        Next = 1,
        Save = 2,
        Terminat = 3,
    }
    ...
    enum SecurityAlarmStatus {
        None = 0,
        NotYetAck = 1,
        Acked = 2,
    }
    enum ScanStatusOption {
        On = 1,
        Off = 2,
    }
    enum AdditiveInjectionMode {
        Auto = 0,
        Manual = 1,
    }
    enum ValveOperationType {
        Undefine = 0,
        MCS = 1,
        MCR = 2,
        MCF = 3,
    ...
    enum ActivityPagingType {
        None = 0,
        Previous = 1,
        Next = 2,
    }
    class FRMessageConstants {
        static TASK_PEND_SUCCEEDED: string;
        static TASK_COMPLETE_SUCCEEDED: string;
        static CHANGE_SPECIFIED_STOP_COND_SUCCEEDED: string;
        static ACTIVITY_START_REQUEST_SUCCEEDED: string;
        static ACTIVITY_FINISH_REQUEST_SUCCEEDED: string;
        static RATIO_CHANGE_SUCCEEDED: string;
        static PATH_CANCEL_SUCCEEDED: string;
        static PATH_RELEASE_SUCCEEDED: string;
        static PATH_CONFIRM_SUCCEEDED: string;
        static PATH_NOMINATE_SUCCEEDED: string;
        static ACTIVITY_CANCEL_SUCCEEDED: string;
        static SPIKING_TANK_ADDITION_SUCCEEDED: string;
        static SPIKING_TANK_DELETION_SUCCEEDED: string;
        static SPIKING_TANK_RELEASE_SUCCEEDED: string;
        static SPIKING_TANK_SWING_START_SUCCEEDED: string;
        static PUMP_ADDITION_SUCCEEDED: string;
        static PUMP_DELETION_SUCCEEDED: string;
    }
}
declare namespace EnterpriseSolution {
    class Common {
